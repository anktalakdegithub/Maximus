      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Research Report </span></p>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="blog-entry">
              ...
              <div class="text border border-top-0 p-4">
                ...
                <div class="d-flex align-items-center mt-4">
	                <p class="mb-0"><a href="POLICIES/20MSL_Nomination Form .pdf" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
